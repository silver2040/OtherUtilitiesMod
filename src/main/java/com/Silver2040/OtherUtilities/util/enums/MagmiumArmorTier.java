...
public enum MagmiumArmorTier implements IArmorMaterial {

    // netherite's maxDamageFactor is 37
    MAGMIUM(OtherUtilities.MOD_ID + ":magmium", 50, new int[]{3, 6, 8, 3}, 15, SoundEvents.ENTITY_ARROW_HIT_PLAYER, 8.0F, 1, () -> {
    ...
    MagmiumArmorTier(String name, int maxDamageFactor, int[] damageReductionAmountArray, int enchantability,
