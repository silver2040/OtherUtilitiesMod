...
public enum ArmorTier implements IArmorMaterial {
    ...
    VIBRANIUM(OtherUtilities.MOD_ID + ":vibranium", 63, new int[]{3, 6, 8, 3}, 15, SoundEvents.ENTITY_ARROW_HIT_PLAYER, 6.0F, 0.7F, () -> {
    ...
    ArmorTier(String name, int maxDamageFactor, int[] damageReductionAmountArray, int enchantability,
