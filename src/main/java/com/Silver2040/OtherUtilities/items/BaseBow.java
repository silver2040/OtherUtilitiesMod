            ...
            if (!itemstack.isEmpty() || flag) {
                ...
                if (!((double)f < 0.1D)) {
                    ...
                    if (!worldIn.isRemote) {
                        ...
                        if (j > 0) {
                            abstractarrowentity.setDamage(this.damage + abstractarrowentity.getDamage() + (double)j * 0.5D + 0.5D);
                        } else {
                            abstractarrowentity.setDamage(this.damage +  abstractarrowentity.getDamage() + 1.0D);
                        }
